...
st.sidebar.markdown("For Educational Purposes ONLY. Nothing in this site should be taken as an actual advice")
st.sidebar.markdown("Do your own due deligince at better websites to make your property-related decisions")